        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-xl-7 wow fadeInLeft" data-wow-delay="0.2s">
                    <div>
                        <h4 class="text-primary">USG Urologi</h4>
                        ...
                        <p>
                            Berikut kami lampirkan detail dan spesifikasi kebutuhan USG Urologi
                            <br>
                            Silahkan klik tombol dibawah
                        </p>
                        <div class="row g-4">
                            <div class="col-sm-6">
                                <a class="btn btn-primary rounded-pill py-3 px-5 flex-shrink-0" download href="{{ asset('assets/doc/KAK-USG-UROLOGI.pdf') }}">Download</a>
                            </div>
                        </div>
                        <p class="mt-3">
                ...
                <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
                    <div class="bg-primary rounded position-relative overflow-hidden">
                        <img alt="" class="img-fluid rounded w-100" src="{{ asset('assets/img/usg-urologi.png') }}">
                    </div>
                </div>
                <div class="col-xl-7 wow fadeInLeft" data-wow-delay="0.2s">
